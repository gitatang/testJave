...
### 1. 基本类型
| 类型     | 位数  | 大小（字节 | 包装类       | 默认值    | 范围                                                 |
|--------|-----|------|-----------|--------|----------------------------------------------------|
| byte   | 8位  | 1    | Byte      | 0      | -$2^{7}$~$2^{7}$-1 (-128~127)                      |
| short  | 16位 | 2    | Short     | 0      | -$2^{15}$~$2^{15}$-1 (-32,768 ~ 32,767)            |
| int    | 32位 | 4    | Integer   | 0      | -$2^{31}$~$2^{31}$-1 (-2,147,483,648 ~ 2,147,483,647) |
| long   | 64位 | 8    | Long      | 0      | -$2^{63}$~$2^{63}$-1 (-9.22×$10^{18}$量级)           |
| float  | 32位 | 4    | Float     | 0.0f   | IEEE 754 单精度浮点数                                    |
| double | 64位 | 8    | Double    | 0.0d   | IEEE 754 双精度浮点数                                    |
| char   | 16位 | 2    | Character | '\u0000' | '\u0000' ~ '\uffff' (0 ~ 65,535)                                   |
| boolean | 1位  | 1    |Boolean     | false  |true / false                                     |
**封装**
